...
GET_ROUTES = [
    ...
    (_exact("/api/setup/db-detect"),          "g_setup_db_detect",       "none"),
    (_exact("/api/setup/mysql-versions"),     "g_setup_mysql_versions",  "none"),
    (_exact("/api/setup/download-tools/status"), "g_setup_download_tools_status", "none"),
    (_exact("/api/setup/install-mysql/status"), "g_setup_install_mysql_status", "none"),
...
POST_ROUTES = [
    ...
    (_exact("/api/setup/mysql-suggestions"),  "p_setup_mysql_suggestions", "body"),
    ...
    (_exact("/api/setup/install-mysql"),      "p_setup_install_mysql",   "body"),
